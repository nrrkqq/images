...
do
	function Register_Font(Name, Weight, Style, Asset)
		...
		writefile(Name .. ".font", GetService("HttpService"):JSONEncode(Data))
	...
	local ProggyTiny = Register_Font("Tahoma", 200, "Normal", {
		Id = "Tahoma.ttf",
		Font = Get("https://raw.githubusercontent.com/0x340/Priv9-UI-Libary/main/fonts/tahoma_bold.ttf"),
	})

	local ProggyClean = Register_Font("ProggyClean", 200, "normal", {
		Id = "ProggyClean.ttf",
		Font = Get("https://raw.githubusercontent.com/0x340/Priv9-UI-Libary/main/fonts/ProggyClean.ttf"),
	})
...
function notifications:create_notification(options)
	local cfg = {
		name = options.name or "q3sm (finobe)",
		outline,
	}
...
function library:colorpicker(options)
	...
	function cfg.set_visible(bool)
		...
		colorpicker.Position = dim_offset(
			...
			colorpicker_element_color.AbsolutePosition.Y + colorpicker_element_color.AbsoluteSize.Y + 65
		)
	end
	...
	function cfg.update_color()
		...
		if dragging_sat then
			s = math.clamp(
				(offset - saturation_value_button.AbsolutePosition).X / saturation_value_button.AbsoluteSize.X,
				0,
				1
			)
			v = 1
				- math.clamp(
					(offset - saturation_value_button.AbsolutePosition).Y / saturation_value_button.AbsoluteSize.Y,
					0,
					1
				)
